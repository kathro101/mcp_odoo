...
class TestFormatFieldDetail:
    ...
    def test_auto_generated_shows_warning(self):
        """Field with auto_generated=True should show AUTO-GENERATED warning."""
        from src.mcp_server.tools import _format_field_detail
        ...
        assert "do NOT set" in result

    def test_normal_field_no_auto_generated_warning(self):
        """Regular fields should NOT show auto-generated warning."""
        from src.mcp_server.tools import _format_field_detail
...
class TestFormatSchemaSubModels:
    """Tests for sub-model target fields in _format_schema_for_claude."""

    def test_sub_model_includes_target_fields(self):
        """Sub-models should show writable target fields."""
        from src.mcp_server.tools import _format_schema_for_claude
        from src.shared.types import ModelSchema, SubModelSchema
        ...
        result = _format_schema_for_claude(schema)
        text = "\n".join(result)
        assert "name, type" in text
        assert "Required: name" in text

    def test_sub_model_without_target_fields_still_shown(self):
        """Sub-models without target_fields should still be listed."""
        from src.mcp_server.tools import _format_schema_for_claude
        from src.shared.types import ModelSchema, SubModelSchema
        ...
        result = _format_schema_for_claude(schema)
        text = "\n".join(result)
        assert "line_ids" in text
        assert "sale.order.line" in text


class TestFormatSchemaAutoGenerated:
    """Tests for AUTO-GENERATED section in _format_schema_for_claude."""

    def test_auto_generated_section_when_fields_exist(self):
        """AUTO-GENERATED FIELDS section should appear when auto-generated fields exist."""
        from src.mcp_server.tools import _format_schema_for_claude
        from src.shared.types import FieldInfo, ModelSchema
        ...
        assert "system-generated" in text

    def test_no_auto_generated_section_when_none(self):
        """No AUTO-GENERATED section when all fields are normal."""
        from src.mcp_server.tools import _format_schema_for_claude
        from src.shared.types import FieldInfo, ModelSchema
